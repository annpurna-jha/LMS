...
//        addBook();
    ...
    //    clear field after every action like add update delete
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 100, 30, 30));

        jLabel9.setFont(new java.awt.Font("Verdana", 0, 17)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(255, 255, 255));
        jLabel9.setText("Enter Book Id");
        jPanel1.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 70, 160, 20));
        ...
        jPanel1.add(txt_bookId, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 100, 270, 30));
        ...
        jPanel1.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 200, 30, 30));

        jLabel10.setFont(new java.awt.Font("Verdana", 0, 17)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(255, 255, 255));
        jLabel10.setText("Enter Book Name");
        jPanel1.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 170, 180, 20));
        ...
        jPanel1.add(txt_bookName, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 200, 290, 30));
        ...
        jPanel1.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 300, 30, 30));

        jLabel11.setFont(new java.awt.Font("Verdana", 0, 17)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(255, 255, 255));
        jLabel11.setText("Author Name");
        jPanel1.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 270, 120, -1));
        ...
        jPanel1.add(txt_authorName, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 300, 270, -1));
        ...
        jPanel1.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 400, 30, 30));

        jLabel13.setFont(new java.awt.Font("Verdana", 0, 17)); // NOI18N
        jLabel13.setForeground(new java.awt.Color(255, 255, 255));
        jLabel13.setText("Quantity");
        jPanel1.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 380, 240, 20));
        ...
        jPanel1.add(txt_quantity, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 420, 270, 30));
        ...
        jPanel1.add(rSMaterialButtonCircle1, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 490, 130, 60));
        ...
        jPanel1.add(rSMaterialButtonCircle2, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 490, 130, 60));
        ...
        jPanel1.add(rSMaterialButtonCircle3, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 490, 130, 60));
        ...
        jPanel3.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 190, 610, 220));
        ...
        jPanel3.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 50, 250, 50));
        ...
        jPanel3.add(jPanel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 110, 280, 5));
    ...
    private void rSMaterialButtonCircle1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSMaterialButtonCircle1ActionPerformed
        ...
        if(deleteBook() == true){
            JOptionPane pane = new JOptionPane( "Book Deleted Successfully" , JOptionPane.INFORMATION_MESSAGE);
...
//            JOptionPane.showMessageDialog(this, "Book Added Successfully");
            ...
            JOptionPane pane = new JOptionPane( "Book Added Successfully" , JOptionPane.INFORMATION_MESSAGE);
                JDialog dialog = pane.createDialog("Information");
                Timer timer = new Timer(displayTime, e -> {
                    dialog.dispose(); 
                    clearTable();
...
//            clearField();
    ...
    private void rSMaterialButtonCircle3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSMaterialButtonCircle3ActionPerformed
        if(updateBook() == true){
            JOptionPane pane = new JOptionPane("Book Updated", JOptionPane.INFORMATION_MESSAGE);
            JDialog dialog = pane.createDialog("Information");
